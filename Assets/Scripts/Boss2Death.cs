...
public class Boss2Death : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hpBar.value = health;
        enemy.health = health;
        healthThreshold = enemy.health / 3;
    ...
    void Update()
    {
        ...
        {
            GetComponent<Boss2AttackHandler>().Spin();
        }
    ...
    {
        DisableComponents();
        GetComponent<Boss2AttackHandler>().DisableBothSideLasers(); //also turns off main
    ...
    {
        GetComponent<Boss2AttackHandler>().StopAllCoroutines();
        GetComponent<Boss2AttackHandler>().enabled = false;
        GetComponent<BoxCollider>().enabled = false;

        BoxCollider[] cols = GetComponentsInChildren<BoxCollider>();
        foreach(BoxCollider box in cols)
        {
            box.enabled = false;
        }
